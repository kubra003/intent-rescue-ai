...
export function EmergencyInputPanel() {
  ...
  return (
    <section className="bg-white/70 backdrop-blur-[60px] p-8 md:p-12 rounded-[3.5rem] shadow-[0_30px_100px_rgba(0,0,0,0.08)] w-full max-w-2xl border border-white" aria-label="Emergency Input Form">
      <h2 className="text-3xl md:text-5xl font-black mb-10 flex items-center gap-5 text-slate-800 uppercase tracking-widest leading-none drop-shadow-sm">
      ...
      <div className="space-y-8">
        ...
        {imagePreview && (
          <div className="relative mt-6 border border-slate-200 rounded-[2.5rem] overflow-hidden shadow-2xl w-full p-2 bg-white/80 backdrop-blur-xl animate-in fade-in zoom-in duration-500">
            <img src={imagePreview} alt="Uploaded" className="w-full h-80 object-cover rounded-[2rem] opacity-90" />
            <button 
